...
def payment(request):
    ...
    order_id = Order.objects.get(customer_id=customer_id,status='unpaid').id
    ...
    if payment_status=='OK':
        ...
        if 'data' in resp.json():
            ...
            if payment_code == 100:
                ...
                return Response('payment failed',status=status.HTTP_401_UNAUTHORIZED)
